 ...
 * @author Ayush
 */
public class Packet_Capture1 extends javax.swing.JFrame {
    private TCP taskTCP;
    private UDP taskUDP;
     ...
     */
    public Packet_Capture1() throws HeadlessException{
        initComponents();
    ...
    for(PcapIf device: alldevs){
           try {
               ...
               Logger.getLogger(Packet_Capture1.class.getName()).log(Level.SEVERE, null, ex);
           }
            }
        System.out.printf("**************************************************************");
   ...
   pcap.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Packet_Capture1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Packet_Capture1().setVisible(true);
            }
        });
    }
